<footer class="page-footer">
    ...
    <div class="row">
      <div class="col m3">
        ...
        <p>
          ...
          <a href="{{ eae_encode_str('hello@unitymakes.us') }}">
  ...
  <div class="footer-copyright">
    <div class="container">
    <i class="cc cc-by"></i> {{ the_time('Y') }} Unity Digital Agency. Photo credits <a href="http://www.wocintechchat.com/" target="_blank">#WOCinTech</a> and <a href="https://unsplash.com/" target="_blank">Unsplash</a>.
    </div>
  </div>
</footer>
